...
def generate_launch_description():
    ...
    ego_planner_node = Node(
        ...
        remappings=[
            ...
            ('grid_map/odom', ['drone_', drone_id, '_', odom_topic]), # 地图用里程计: /vins_estimator/odometry
            ('grid_map/cloud', ['drone_', drone_id, '_', 'nouse2']), # 不使用点云
            ('grid_map/pose', ['drone_', drone_id, '_', 'nouse1']),# 不使用相机位姿
            ('grid_map/depth', ['drone_', drone_id, '_', depth_topic]), # 深度相机: /camera/camera/depth/image_raw
            # 栅格地图可视化输出（与RViz一致）
