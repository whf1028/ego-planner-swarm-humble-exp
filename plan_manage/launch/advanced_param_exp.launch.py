...
def generate_launch_description():
    ...
    resolution = LaunchConfiguration('resolution_', default=0.1)
    ...
    planning_horizon = LaunchConfiguration('planning_horizon_', default=7.5)
    ...
    resolution_arg = DeclareLaunchArgument('resolution_', default_value=resolution, description='Resolution')
    ...
    planning_horizon_arg = DeclareLaunchArgument('planning_horizon_', default_value=planning_horizon, description='Planning horizon')
    ...
    cloud_topic_arg = DeclareLaunchArgument('cloud_topic', default_value=cloud_topic, description='Cloud topic')
    
    cx_arg = DeclareLaunchArgument('cx', default_value=cx, description='Camera intrinsic parameter cx')
    cy_arg = DeclareLaunchArgument('cy', default_value=cy, description='Camera intrinsic parameter cy')
    fx_arg = DeclareLaunchArgument('fx', default_value=fx, description='Camera intrinsic parameter fx')
    fy_arg = DeclareLaunchArgument('fy', default_value=fy, description='Camera intrinsic parameter fy')
    ...
    point0_x_arg = DeclareLaunchArgument('point0_x', default_value=point0_x, description='Waypoint 0 X')
    point0_y_arg = DeclareLaunchArgument('point0_y', default_value=point0_y, description='Waypoint 0 Y')
    point0_z_arg = DeclareLaunchArgument('point0_z', default_value=point0_z, description='Waypoint 0 Z')
    point1_x_arg = DeclareLaunchArgument('point1_x', default_value=point1_x, description='Waypoint 1 X')
    point1_y_arg = DeclareLaunchArgument('point1_y', default_value=point1_y, description='Waypoint 1 Y')
    point1_z_arg = DeclareLaunchArgument('point1_z', default_value=point1_z, description='Waypoint 1 Z')
    point2_x_arg = DeclareLaunchArgument('point2_x', default_value=point2_x, description='Waypoint 2 X')
    point2_y_arg = DeclareLaunchArgument('point2_y', default_value=point2_y, description='Waypoint 2 Y')
    point2_z_arg = DeclareLaunchArgument('point2_z', default_value=point2_z, description='Waypoint 2 Z')
    point3_x_arg = DeclareLaunchArgument('point3_x', default_value=point3_x, description='Waypoint 3 X')
    point3_y_arg = DeclareLaunchArgument('point3_y', default_value=point3_y, description='Waypoint 3 Y')
    point3_z_arg = DeclareLaunchArgument('point3_z', default_value=point3_z, description='Waypoint 3 Z')
    point4_x_arg = DeclareLaunchArgument('point4_x', default_value=point4_x, description='Waypoint 4 X')
    point4_y_arg = DeclareLaunchArgument('point4_y', default_value=point4_y, description='Waypoint 4 Y')
    point4_z_arg = DeclareLaunchArgument('point4_z', default_value=point4_z, description='Waypoint 4 Z')
    
    flight_type_arg = DeclareLaunchArgument('flight_type', default_value=flight_type, description='Flight type')
